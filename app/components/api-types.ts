...
export type get_GetExploreRecipes = typeof get_GetExploreRecipes;
export const get_GetExploreRecipes = {
  method: z.literal("GET"),
  path: z.literal("/api/recipes/{recipeId}/explore"),
  parameters: z.object({
    query: z.object({
      slowdown: z.number().optional(),
    }),
...
export const EndpointByMethod = {
  get: {
    ...
    "/api/recipes/{recipeId}/explore": get_GetExploreRecipes,
  },
  post: {
